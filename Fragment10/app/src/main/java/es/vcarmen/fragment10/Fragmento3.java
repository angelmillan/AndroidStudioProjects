...
/**
 * Created by matinal on 27/10/17.
 */
...
public class Fragmento3 extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ID_ENTRADA_SELECCIONADA)){
            miItem = Contenido.ENT_LISTA_HASMAP.get(getArguments().getString(ARG_ID_ENTRADA_SELECCIONADA));
...
/*        if (miItem != null) {
            ...
            ((ImageView) rootView.findViewById(R.id.imagen)).setImageResource(miItem.idImage);
        }*/
        return rootView;
    }
}
